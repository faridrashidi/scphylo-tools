"""SCITE reconstruction.""" "\n---------------------"

# %%
# This example shows how to construct a phylogenetic tree using SCITE on a binary
...
# %%
# Next, using :func:`scphylo.tl.scite` we remove the single-cell noises from the
# input.
